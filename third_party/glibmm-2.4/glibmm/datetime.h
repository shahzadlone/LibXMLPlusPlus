...
public:
   ...
   * This is a gnulib strftime() extension. @newin{2,38}
   * - \\%::z: the time zone as an offset from UTC (+hh:mm:ss). This is a
   * gnulib strftime() extension. @newin{2,38}
   * - \\%:::z: the time zone as an offset from UTC, with : to necessary
   * precision (e.g., -04, +05:30). This is a gnulib strftime() extension. @newin{2,38}
